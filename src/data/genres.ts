// Currently not using this data but could be utilized
// to harcode the Genres to improvve UX since they
// pretty much never change, making server fetches for them
